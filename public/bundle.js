...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _NameList = __webpack_require__(25);
		...
		_createClass(App, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_NameList2.default, { number: '1' }),
					',',
					_react2.default.createElement(_NameList2.default, { number: '2' })
				);
			}
		}]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Welcome = __webpack_require__(26);
	...
	var NameList = function (_React$Component) {
		...
		_createClass(NameList, [{
			...
			key: 'render',
			value: function render() {
				var nameArray = ["chris123", "John", "Bob", "Mary"];
				return _react2.default.createElement(
					'div',
					null,
					...
					_react2.default.createElement(_Welcome2.default, { firstName: 'Jeetu', lastName: 'Shrivastava', originalPhrase: this.props.number }),
					_react2.default.createElement(
						'ul',
						null,
						this.nameMapper(nameArray)
					),
					_react2.default.createElement(_Welcome2.default, { firstName: 'Jeetu', lastName: 'Shrivastava' })
				);
			}
		}]);
...
/***/ (function(module, exports, __webpack_require__) {
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'h2',
						null,
						'The top level Component passed this message along: ',
						this.props.originalPhrase
					),
					_react2.default.createElement(
						'h4',
						null,
	...
	var lengthChecker = function lengthChecker(props, propName, component) {
		if (props[propName]) {
	...
	Welcome.propTypes = {
		...
		originalPhrase: _propTypes2.default.string.isRequired
	};
